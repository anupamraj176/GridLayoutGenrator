...
const CyberGridGenerator = () => {
  ...
  const THEME = {
    ...
    bg: "#0a0a0a",
    cellBg: "rgba(168, 85, 247, 0.12)",
    cellHover: "rgba(168, 85, 247, 0.3)",
    itemBg: "linear-gradient(135deg, rgba(168, 85, 247, 0.35) 0%, rgba(99, 102, 241, 0.35) 100%)",
    itemBorder: "rgba(168, 85, 247, 0.6)",
    ...
    <div ref={containerRef} style={{ background: THEME.bg, minHeight: '100vh', color: 'white', paddingTop: isMobile ? '85px' : '100px' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: isMobile ? '1rem' : '2rem', position: 'relative', zIndex: 1 }}>
        ...
        <div ref={gridRef} style={{
          ...
          margin: '0 auto',
          background: `linear-gradient(135deg, ${THEME.accentLight} 0%, rgba(99, 102, 241, 0.08) 100%)`,
          border: `1px solid ${THEME.itemBorder}`,
          borderRadius: isMobile ? '0.75rem' : '1rem', 
          padding: isSmallMobile ? '0.5rem' : isMobile ? '0.75rem' : '1rem', 
          userSelect: resizing ? 'none' : 'auto',
          boxShadow: `0 8px 32px rgba(168, 85, 247, 0.15), inset 0 0 60px rgba(168, 85, 247, 0.05)`
        }}>
            ...
            return (
              <div key={`cell-${index}`} onClick={() => !isOccupied && handleCellClick(row, col)}
                style={{
                  ...
                  border: isOccupied ? 'none' : '1px dashed rgba(168, 85, 247, 0.2)'
                }}
                onMouseEnter={(e) => { 
                  if (!isOccupied) {
            ...
            <button
              ...
              style={{
                ...
                background: outputMode === 'css' 
                  ? `linear-gradient(135deg, ${THEME.accent} 0%, #6366f1 100%)`
                  : 'transparent',
                border: 'none',
                borderRadius: '0.5rem',
          ...
          {[
            ...
            <div key={type} style={{
              ...
              <div style={{
                ...
                right: 0,
                height: '2px',
                background: `linear-gradient(90deg, ${THEME.accent}, #6366f1, ${THEME.accent})`,
                opacity: 0.6
              }} />
              ...
              <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1rem' }}>
                <button 
                  ...
                  style={{
                    ...
                    fontSize: isSmallMobile ? '0.8rem' : '0.875rem', 
                    fontWeight: '700',
                    boxShadow: `0 4px 15px ${showCopied === type ? 'rgba(16, 185, 129, 0.4)' : 'rgba(168, 85, 247, 0.4)'}`,
                    transition: 'all 0.3s ease',
